      ...
      <CardContent className="py-4 px-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-8">
            <div>
              <p className="text-xs font-medium text-muted-foreground">총 Task</p>
              <p className="text-xl font-bold">
                <AnimatedCounter value={stats.total} duration={1500} />
              </p>
            </div>
            <div>
              <p className="text-xs font-medium text-muted-foreground">완료된 Task</p>
              <p className="text-xl font-bold text-green-400">
                <AnimatedCounter value={stats.completed} duration={1500} />
              </p>
            </div>
            <div>
              <p className="text-xs font-medium text-muted-foreground">남은 Task</p>
